...
func (m *MockDatabase) UpdateBillRecordIsPaid(arg0 context.Context, arg1, arg2 string, arg3 time.Time) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateBillRecordIsPaid", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDatabaseMockRecorder) UpdateBillRecordIsPaid(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateBillRecordIsPaid", reflect.TypeOf((*MockDatabase)(nil).UpdateBillRecordIsPaid), arg0, arg1, arg2, arg3)
}
